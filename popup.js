class PureNotepadPopup {
    ...
    async init() {
        console.log('Loading Pure Notepad popup data...');
        await this.loadData();
        console.log('Setting up popup elements...');
        this.setupElements();
        console.log('Setting up popup event listeners...');
        this.setupEventListeners();
        console.log('Applying popup theme...');
        this.applyTheme();
        console.log('Updating popup notes list...');
        this.updateNotesList();
        console.log('Loading current note in popup...');
        this.loadCurrentNote();
        console.log('Pure Notepad popup initialized successfully!');
    }
